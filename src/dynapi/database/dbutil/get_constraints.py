...
def get_constraints(connection: DatabaseConnection, schema: str, table: str) -> t.List[Constraints]:
    ...
    cursor.execute(r"""SELECT tc.constraint_name, tc.constraint_type, ccu.table_name as referenced_table_name, ccu.column_name as referenced_column_name, c.data_type, c.is_updatable
